...
void Sample::jitter(std::vector<Point>& samples, int n)
{
    int m = sqrt(n);
    for (int i = 0; i < m; i++) {
        for (int j = 0; j < m; j++) {
...
// void Sample::multiJitter(std::vector<Point> samples, int n)
// {
//     int m = sqrt(n);
...
// void Sample::boxFilter(std::vector<Point> samples, int n)
// {
//     for (int i = 0; i < n; i++) {
//         samples[i].x -= 0.5;
//         samples[i].y -= 0.5;
...
// void Sample::tentFilter(std::vector<Point>& samples, int n)
// {
//     for (int i = 0; i < n; i++) {
//         if (samples[i].x < 0.5) {

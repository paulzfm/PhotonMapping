CXX = clang-omp++
SOURCES = $(wildcard *.cpp util/*.cpp util/shape/*.cpp third-party/*.cpp third-party/jsonbox/*.cpp)
HEADERS = $(wildcard *.h util/*.h util/shape/*.h third-party/*.h third-party/jsonbox/*.h)
